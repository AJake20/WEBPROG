  ...
  <div class="container">
    <form action = "?oldal=belep" method = "post">
      <fieldset>
        ...
        <br>
        <input type="text" name="bejelentkezes" placeholder="felhasználó" required><br><br>
     ...
     <form action = "?oldal=regisztral" method = "post">
      <fieldset>
        ...
        <input type="text" name="bejelentkezes" placeholder="felhasználói név" required><br><br>
        <input type="password" name="jelszo" placeholder="jelszó" required><br><br>
